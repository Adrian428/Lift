...
namespace Lift.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<LiftException, Task> _onCustomErrorAsync;
        private Func<LiftException, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<LiftException, Task> onCustomError, 
        ...
        public IHandlerTask OnCustomError(Func<LiftException, Logger, Task> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
			var customException = exception as LiftException;
